...
bennyGarages = {
    [1] = {coords = vector4(462.6910, -1019.56, 27.906, 271.35), useJob = true, job = {"police", "sheriff"}},
    [2] = {coords = vector4(463.1309, -1014.95, 27.361, 268.97), useJob = true, job = {"police", "sheriff"}},
    [3] = {coords = vector4(340.1500, -571.440, 28.800, 337.42), useJob = true, job = {"ambulance"}},
--  [4] = {coords = vector4(1841.135, 3701.887, 33.828, 121.83), useJob = true, job = {"police", "sheriff"}},
--	[5] = {coords = vector4(871.54, -1350.07, 26.31, 274.18), useJob = true, job = {"police", "sheriff"}},
    ...
    [9] = {coords = vector4(-210.31,-1324.47,30.89, 358.61), useJob = true, job = {"bennys"}},
    [10] = {coords = vector4(-222.52,-1330.1,30.89, 269.69), useJob = true, job = {"bennys"}},
    [10] = {coords = vector4(-195.13,-1314.29,26.52, 358.51), useJob = true, job = {"bennys"}},
    [11] = {coords = vector4(540.8,-188.17,53.88, 269.73), useJob = true, job = {"mechanic3"}},
    [12] = {coords = vector4(537.09,-177.61,53.86, 269.44), useJob = true, job = {"mechanic3"}},
    [13] = {coords = vector4(-1155.1,-2005.58,13.18, 140.25), useJob = true, job = {"mechanic4"}},
    [14] = {coords = vector4(-1159.78,-2019.27,13.18, 223.19), useJob = true, job = {"mechanic4"}},
    [15] = {coords = vector4(-339.06,-136.96,39.01, 253.55), useJob = true, job = {"mechanic5"}},
    [16] = {coords = vector4(-325.14,-135.51,39.01, 338.92), useJob = true, job = {"mechanic5"}},
    [17] = {coords = vector4(730.98,-1089.07,22.17, 268.85), useJob = true, job = {"mechanic6"}},
    [18] = {coords = vector4(734.57,-1081.39,22.17, 358.83), useJob = true, job = {"mechanic6"}},


}
bennyGarages1 = {
[1] = {coords = vector4(730.86, -1088.75, 22.17, 270.11), useJob = true, job = {"mechanic"}},
[2] = {coords = vector4(-210.31,-1324.47,30.89, 358.61), useJob = true, job = {"bennys"}},
[3] = {coords = vector4(540.8,-188.17,53.88, 269.73), useJob = true, job = {"mechanic3"}},
}
